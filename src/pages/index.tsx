            ...
            <div className="flex-grow">
                ...
                <div className="h-[25%] relative flex mt-6">
                    <div className="h-full w-[25%] mr-4 border border-neutral-300 shadow-lg rounded-md flex flex-col items-center justify-center">
                        <div className="font-bold text-2xl mb-3">Metric</div>
                ...
                <div className="h-[60%] relative flex flex-col">
                    <div>
                        <h1 className="text-2xl font-bold mt-4 mb-2 text-neutral-500">Recent Activity</h1>
                    </div>
                    <div className="w-full flex-grow flex">
                        ...
                        <div className="w-[25%] relative">
                            <div className="h-full mb-4 w-full border border-neutral-200 shadow-lg rounded-md flex flex-col items-center justify-center">
                                <div className="font-bold text-2xl mb-3">Metric</div>
                                <div className="text-5xl">Value</div>
                            </div>
                        </div>
...
export const Layout = ({ children }: LayoutProps) => {
    return (<>
        ...
        <div className="flex min-h-screen">
            ...
            <main className="px-8 py-8 flex flex-col flex-grow">
                {children}
            </main>
        </div>
    </>)
...
const Visualization = () => {
    const data = [
        { name: '16-9-23', uv: 400, pv: 2400, amt: 2400 }, 
        { name: '17-9-23', uv: 500, pv: 2400, amt: 2400 }, 
        { name: '18-9-23', uv: 300, pv: 2400, amt: 2400 }, 
        { name: '19-9-23', uv: 700, pv: 2400, amt: 2400 },
        { name: '20-9-23', uv: 700, pv: 2400, amt: 2400 },
        { name: 'Yesterday', uv: 700, pv: 2400, amt: 2400 },
        { name: 'Today', uv: 700, pv: 2400, amt: 2400 },
    ]
